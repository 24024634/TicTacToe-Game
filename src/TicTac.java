...
public class TicTac {
    ...
    public static void main(String[] args) {
        ...
        boolean gameISUnderway = true;

        Scanner scanner = new Scanner(System.in);

        while (gameISUnderway) {
            ...
            int shift;
            while (true) {
                System.out.println("Player " + currentPlayer + ", enter your first move (Use a number from 1 to 9): ");
